...
class Lander(object):
    ...
    def __str__(self):
        ...
        capsule = ('LAUNCH IN-PROGRESS' if self.capsule_launching else
                   ...
                   '{}/4'.format(self.capsule_amount))
        clients = ', '.join(map(str, self.clients))
        return ('COLLECTOR {}\r\nCAPSULE {}\r\nUPLINKS: {}'
                .format(collector, capsule, clients))
...
def main():
    ...
    coro = telnetlib3.create_server(port=6023, log=logging.getLogger(), shell=shell)
